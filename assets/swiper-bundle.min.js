...
!(function (e, t) {
  ...
  function i(e, t) {
    ...
    void 0 === t && (t = {}),
        Object.keys(t).forEach(function (s) {
          void 0 === e[s]
              ? (e[s] = t[s])
              : a(t[s]) && a(e[s]) && Object.keys(t[s]).length > 0 && i(e[s],
              t[s]);
        });
  }
  ...
  var g,
      ...
      y = {
        ...
        attr: function (e, t) {
          ...
          for (var a = 0; a < this.length; a += 1) {
            if (2 === arguments.length) {
              ...
              for (var i in e) {
                (this[a][i] = e[i]), this[a].setAttribute(i,
                    e[i]);
              }
            }
          }
        ...
        transitionEnd: function (e) {
          ...
          return (
              ...
              t.on("transitionend", function a(i) {
                i.target === this && (e.call(this, i), t.off("transitionend",
                    a));
              }),
                  this
          );
        ...
        prepend: function (e) {
          ...
          for (t = 0; t < this.length; t += 1) {
            if ("string" == typeof e) {
              ...
              for (s.innerHTML = e, a = s.childNodes.length - 1; a >= 0;
                  a -= 1) {
        ...
        closest: function (e) {
          var t = this;
          return void 0 === e ? m([]) : (t.is(e) || (t = t.parents(e).eq(
              0)), t);
        },
        find: function (e) {
          for (var t = [], a = 0; a < this.length; a += 1) {
        ...
        for (
          ...
          (C(e[l]) && C(i[l])
              ? i[l].__swiper__
                  ...
                  : M(e[l], i[l])
              : !C(e[l]) && C(i[l])
                  ? ((e[l] = {}), i[l].__swiper__ ? (e[l] = i[l]) : M(e[l],
                      i[l]))
                  : (e[l] = i[l]));
        }
      }
        ...
        if (i.freeMode) {
          ...
          for (
            ...
            void 0 !== l[I + O]
                ...
                : p >= l[I] && (($ = I), (L = l[l.length - 1] - l[l.length
            - 2]));
          }
          var A = (p - l[$]) / L,
      ...
      F = {
        ...
        eventsEmitter: {
          ...
          once: function (e, t, a) {
            ...
            function s() {
              ...
              for (var a = arguments.length, r = new Array(a), n = 0; n < a;
                  n++) {
                r[n] = arguments[n];
              }
              t.apply(i, r);
          ...
          onAny: function (e, t) {
            ...
            return (
                a.eventsAnyListeners.indexOf(e) < 0 && a.eventsAnyListeners[i](
                    e), a
            );
          },
          offAny: function (e) {
          ...
          emit: function () {
            ...
            for (var s = arguments.length, r = new Array(s), n = 0; n < s;
                n++) {
              r[n] = arguments[n];
            }
        ...
        update: {
          ...
          updateSlides: function () {
            ...
            if (void 0 !== r) {
                ...
                if ("none" !== O.css("display")) {
                  if ("auto" === i.slidesPerView) {
                    ...
                    if (
                      ...
                      C = e.isHorizontal() ? O.outerWidth(!0) : O.outerHeight(
                          !0);
                    } else {
                      var V = a(R, "width"),
                          W = a(R, "padding-left"),
              ...
              if (
                ...
                s.css(
                    (((z = {})[t("width")] = e.virtualSize + i.spaceBetween
                        + "px"),
                        z),
                );
              }
              ...
              if ((0 === c.length && (c = [0]), 0 !== i.spaceBetween)) {
                var te,
                    ae = e.isHorizontal() && n ? "marginLeft" : t(
                        "marginRight");
          ...
          updateAutoHeight: function (e) {
            ...
            if ("auto" !== a.params.slidesPerView && a.params.slidesPerView
                > 1) {
          ...
          updateSlidesClasses: function () {
            ...
            i.loop && 0 === o.length && (o = a.eq(0)).addClass(
                i.slideNextClass);
            var d = e
            .prevAll("." + i.slideClass)
            .eq(0)
            .addClass(i.slidePrevClass);
            i.loop && 0 === d.length && (d = a.eq(-1)).addClass(
                i.slidePrevClass),
            i.loop &&
        ...
        slide: {
          slideTo: function (e, t, a, i, s) {
            ...
            if (n.initialized && l !== c) {
              if (!n.allowSlideNext && w < n.translate && w
                  < n.minTranslate()) {
                return !1;
              }
              if (
            ...
            if (
              ...
              return (
                  ...
                  "reset" !== b && (n.transitionStart(a, b), n.transitionEnd(a,
                      b)),
                      !1
              );
            }
          ...
          slideToLoop: function (e, t, a, i) {
            ...
            var s = this,
                r = e;
            return s.params.loop && (r += s.loopedSlides), s.slideTo(r, t, a,
                i);
          },
          ...
          slidePrev: function (e, t, a) {
            ...
            return (
                ...
                void 0 !== h && (p = l.indexOf(h)) < 0 && (p = i.activeIndex
                    - 1),
                    i.slideTo(p, e, t, a)
            );
          },
        ...
        loop: {
          loopCreate: function () {
            var e = this,
                ...
                i = e.$wrapperEl;
            i.children(
                "." + a.slideClass + "." + a.slideDuplicateClass).remove();
        ...
        manipulation: {
          appendSlide: function (e) {
            var t = this,
                ...
                i = t.params;
            if (
                (i.loop && t.loopDestroy(), "object" == typeof e && "length"
                in e)
            ) {
          ...
          addSlide: function (e, t) {
            ...
            if (e <= 0) {
              ...
              for (var l = r > e ? r + 1 : r, o = [], d = n - 1; d >= e;
                  d -= 1) {
                var p = a.slides.eq(d);
        ...
        breakpoints: {
          ...
          getBreakpoint: function (e, t, a) {
            if ((void 0 === t && (t = "window"), e && ("container" !== t
                || a))) {
              var i = !1,
                  s = l(),
            ...
            (n.enable = function () {
              ...
              e.params.grabCursor && e.setGrabCursor(),
                ...
                (n.update = function () {
                  ...
                  function i() {
                    var t = e.rtlTranslate ? -1 * e.translate : e.translate,
                        a = Math.min(Math.max(t, e.maxTranslate()),
                            e.minTranslate());
                    e.setTranslate(
                        a), e.updateActiveIndex(), e.updateSlidesClasses();
                  }
                }),
                ...
                (n.mount = function (e) {
                  ...
                  var i = function () {
                        return (
                            "." + (t.params.wrapperClass || "").trim().split(
                                " ").join(".")
                        );
                      },
                      s = (function () {
                  ...
                  if (0 === s.length && t.params.createElements) {
                    ...
                    (s = m(n)),
                        ...
                        a.append(n),
                        a.children("." + t.params.slideClass).each(
                            function (e) {
                              s.append(e);
                            });
                  }
                  return (
                      M(t, {
                        ...
                        mounted: !0,
                        rtl:
                            "rtl" === e.dir.toLowerCase() || "rtl" === a.css(
                                "direction"),
                        rtlTranslate:
                ...
                (t.installModule = function (e) {
                  ...
                  var a = e.name || Object.keys(t.prototype.modules).length
                      + "_" + x();
  ...
  var j = {
        update: function (e) {
          ...
          (m = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top"),
              r
                  ? ((g = Math.floor(i / 2) + s + o), (b = Math.floor(i / 2) + s
                      + l))
                  : ((g = i + (s - 1) + o), (b = s + l));
  ...
  var J = {
          ...
          if (
            ...
            if (
                (e.params.loop
                    ...
                    i > n - 1 && (i -= n),
                    i < 0 && "bullets" !== e.params.paginationType && (i = n
                        + i))
              ...
              if (
                  ...
                  ((e.pagination.dynamicBulletIndex += i - e.previousIndex),
                      ...
                      (d =
                          ((o = l + (Math.min(p.length, a.dynamicMainBullets)
                                  - 1)) +
                              l) /
                          2)),
                      p.removeClass(
              ...
              (n || l
                  ...
                  (n =
                      n.indexOf("%") >= 0
                          ? parseInt(n, 10) * t * s + "%"
                          : n * t * s + "px"),
                  (l = l.indexOf("%") >= 0 ? parseInt(l, 10) * t + "%" : l * t
                      + "px"),
              null != d)
          ) {
      ...
      ie = {
        ...
        onGestureStart: function (e) {
          ...
          0 !== r.$imageWrapEl.length)
              ? (r.$imageEl && r.$imageEl.transition(
                  0), (t.zoom.isScaling = !0))
              : (r.$imageEl = void 0);
        },
        ...
        onTouchStart: function (e) {
          ...
          (s.isTouched ||
              (t.android && e.cancelable && e.preventDefault(),
                  (s.isTouched = !0),
                  (s.touchesStart.x =
                      "touchstart" === e.type ? e.targetTouches[0].pageX
                          : e.pageX),
                  (s.touchesStart.y =
                      "touchstart" === e.type ? e.targetTouches[0].pageY
                          : e.pageY)));
        },
            ...
            if (!(n < i.slideWidth && l < i.slideHeight)) {
              if (
                  ((s.minX = Math.min(i.slideWidth / 2 - n / 2, 0)),
                      ...
                      (s.maxY = -s.minY),
                      (s.touchesCurrent.x =
                          "touchmove" === e.type ? e.targetTouches[0].pageX
                              : e.pageX),
                      (s.touchesCurrent.y =
                          "touchmove" === e.type ? e.targetTouches[0].pageY
                              : e.pageY),
              ...
              e.cancelable && e.preventDefault(),
                  e.stopPropagation(),
                  (s.isMoved = !0),
                  (s.currentX = s.touchesCurrent.x - s.touchesStart.x
                      + s.startX),
                  (s.currentY = s.touchesCurrent.y - s.touchesStart.y
                      + s.startY),
              s.currentX < s.minX &&
              (s.currentX =
              ...
              Math.abs(s.touchesCurrent.y - r.prevPositionY) < 2 && (r.y = 0),
                  ...
                  i.$imageWrapEl.transform(
                      "translate3d(" + s.currentX + "px, " + s.currentY
                      + "px,0)",
                  );
            }
          }
          ...
          (T.$slideEl.addClass("" + x.zoomedSlideClass),
              void 0 === C.touchesStart.x && e
                  ? ((t =
                      ...
                      (a = "touchend" === e.type ? e.changedTouches[0].pageY
                          : e.pageY))
        ...
        out: function () {
          ...
          ((t.scale = 1),
              ...
              i.$imageEl.transition(300).transform(
        ...
        enable: function () {
          ...
          if (!a.enabled) {
            ...
            (e.zoom.passiveListener = i),
                ...
                t.gestures
                    ? (e.$wrapperEl.on(e.touchEvents.start,
                        e.zoom.enableGestures, i),
                        e.$wrapperEl.on(e.touchEvents.end, e.zoom.disableGestures,
                            i))
                    : "touchstart" === e.touchEvents.start &&
                    (e.$wrapperEl.on(e.touchEvents.start, r, a.onGestureStart,
                        i),
                        e.$wrapperEl.on(e.touchEvents.move, r,
                            a.onGestureChange, s),
                        e.$wrapperEl.on(e.touchEvents.end, r, a.onGestureEnd,
                            i),
                    e.touchEvents.cancel &&
                    e.$wrapperEl.on(e.touchEvents.cancel, r, a.onGestureEnd,
                        i)),
                e.$wrapperEl.on(
                    e.touchEvents.move,
        ...
        disable: function () {
          ...
          if (t.enabled) {
            ...
            var i = !(
                ...
                r = "." + e.params.slideClass;
            a.gestures
                ? (e.$wrapperEl.off(e.touchEvents.start, e.zoom.enableGestures,
                    i),
                    e.$wrapperEl.off(e.touchEvents.end, e.zoom.disableGestures, i))
                : "touchstart" === e.touchEvents.start &&
                (e.$wrapperEl.off(e.touchEvents.start, r, t.onGestureStart, i),
                    e.$wrapperEl.off(e.touchEvents.move, r, t.onGestureChange,
                        s),
      ...
      ne = {
        ...
        init: function () {
          ...
          var i = e.$wrapperEl,
              s = i.attr("id") || "swiper-wrapper-" + e.a11y.getRandomNumber(
                  16),
              r = e.params.autoplay && e.params.autoplay.enabled ? "off"
                  : "polite";
          e.a11y.addElId(i, s),
                        ...
                        : e.isEnd
                            ? e.params.autoplay.stopOnLastSlide
                                ...
                                : ((t = e.slideTo(0, e.params.speed, !0, !0)),
                                    e.emit("autoplay"))
                            : ((t = e.slideNext(e.params.speed, !0, !0)), e.emit(
                                "autoplay")),
        ...
        onMouseEnter: function () {
          ...
          e.params.autoplay.disableOnInteraction
              ...
              ["transitionend", "webkitTransitionEnd"].forEach(function (t) {
                e.$wrapperEl[0].removeEventListener(t,
          ...
          on: {
            ...
            click: function (e, t) {
              var a = e.navigation,
                  ...
                  s = a.$prevEl,
                  r = t.target;
              if (e.params.navigation.hideOnClick && !m(r).is(s) && !m(r).is(
                  i)) {
                if (
                    e.pagination &&
                    e.params.pagination &&
                ...
                i
                    ...
                    !0 === n ? e.emit("navigationShow") : e.emit(
                        "navigationHide"),
